import { z } from 'zod';
export const eventTypes = ['RUN_STARTED','RUN_RESET','RUN_FINISHED','RUN_FAILED','RUN_STOPPED','RUN_TIMING','AGENT_CREATED','AGENT_STARTED','AGENT_MESSAGE','AGENT_FINISHED','AGENT_FAILED','AGENT_TERMINATED','TOOL_REQUEST','TOOL_ALLOWED','TOOL_DENIED','TOOL_RESULT','HTTP_REQUEST','HTTP_RESPONSE','ARTIFACT_DISCOVERED','CAPABILITY_GAINED','CAPABILITY_DELEGATED','CAPABILITY_REVOKED','TAINT_OBSERVED','PROVENANCE_PROPAGATED','POLICY_WARNING','POLICY_BLOCK','AGENT_QUARANTINED','MESSAGE_BLOCKED','CANARY_ACCESSED','CANARY_LEAK','CANARY_SAFE','WASMER_PROCESS_STARTED','WASMER_PROCESS_EXITED','TENKI_AUTH_OK','TENKI_AUTH_FAILED','TENKI_SANDBOX_CREATED','TENKI_PROVISION_STARTED','TENKI_PROVISION_READY','TENKI_HEALTH_FAILED','TENKI_RESET','TENKI_SANDBOX_DESTROYED','MODEL_REQUEST','MODEL_RESPONSE'] as const;
