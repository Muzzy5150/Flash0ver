...
export type AgentState='created'|'running'|'waiting'|'finished'|'failed'|'quarantined'|'terminated';
...
export const ROLE_SERVICES:Record<Role,Service[]>={coordinator:[],recon:['entry'],analyst:['internal'],operator:['privileged','vault','collector']};
