...
| 0:30–1:25 | Follow the breach rail and **DECEPTION GRID** while WEB, CODE, IDENTITY, and OBSERVABILITY run. | “The swarm has touched real, harmless tripwires inside this disposable range. Each signal names the agent, service, asset class, and provenance path. A decoy hit raises evidence; it does not claim compromise. The blast radius comes from services the swarm actually reached or exposed.” |
...
| 2:40–3:00 | Show **EMERGENT CAPABILITY BLOCKED**, contained blast radius, then ACME still HEALTHY. | “The collector is clean and production never changed. Real tripwires fired, but the dangerous composition was contained. Unrelated agents stayed operational, and the final canary remained safe.” |
